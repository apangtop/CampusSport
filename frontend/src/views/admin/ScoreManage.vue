  ...
  <div>
    ...
    <el-card shadow="never">
      ...
      <el-table :data="scores" v-loading="loading">
        ...
        <el-table-column v-if="filterStage === 'preliminary'" label="晋级" width="90" align="center">
          <template #default="{ row }">
...
async function loadScores() {
  ...
  loading.value = true
  const res = await scoreApi.list({ event: filterEvent.value, stage: filterStage.value })
